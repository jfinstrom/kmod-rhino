...
#include "../version.h"
#define R1T1VER "3.00"
#define R1T1VERFULL R1T1VER " 06/02/08"
...
extern void __r1t1_card_dsp_out(struct r1t1 *rh, const unsigned int addr, const unsigned int value);

extern unsigned int __r1t1_card_pci_in(struct r1t1 *rh, const unsigned int addr);
extern void __r1t1_card_pci_out(struct r1t1 *rh, const unsigned int addr, const unsigned int value);
