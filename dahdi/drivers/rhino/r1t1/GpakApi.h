 ...
 *
 */
extern gpakConfigChanStatus_t gpakConfigureChannel(struct r1t1 *rh,	/* Card containing the DSP */
...
extern gpakTearDownStatus_t gpakTearDownChannel(struct r1t1 *rh,	/* Card containing the DSP */
												unsigned short int DspId,	// DSP identifier
												unsigned short int ChannelId,	// channel identifier
 ...
 *
 */
extern gpakAlgControlStat_t gpakAlgControl(struct r1t1 *rh,	/* Card containing the DSP */
										   unsigned short int DspId,	// DSP identifier
										   unsigned short int ChannelId,	// channel identifier
 ...
 *
 */
extern gpakConfigPortStatus_t gpakConfigurePorts(struct r1t1 *rh,	/* Card containing the DSP */
												 unsigned short int DspId,	// DSP identifier
...
extern gpakDownloadStatus_t gpakDownloadLoader(struct r1t1 *rh,	/* Card containing the DSP */
 ...
 *
 */
extern gpakDownloadStatus_t gpakDownloadDsp_5510(struct r1t1 *rh,	/* Card containing the DSP */
												 unsigned short int DspId,	// DSP identifier
												 GPAK_FILE_ID FileId	// G.PAK download file identifier
	);

extern gpakDownloadStatus_t gpakDownloadDsp_5507(struct r1t1 *rh,	/* Card containing the DSP */
												 unsigned short int DspId,	// DSP identifier
												 GPAK_FILE_ID FileId	// G.PAK download file identifier
	);
 ...
 */
extern gpakReadEventFIFOMessageStat_t gpakReadEventFIFOMessage(struct r1t1 *rh,	// Card containing the DSP
															   unsigned short int DspId,	// DSP identifier
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakPingDspStat_t gpakPingDsp(struct r1t1 *rh,	/* Card containing the DSP */
									 unsigned short int DspId,	// DSP identifier
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakSerialTxFixedValueStat_t gpakSerialTxFixedValue(struct r1t1 *rh,	/* Card containing the DSP */
														   unsigned short int DspId,	// DSP identifier
														   unsigned short int ChannelId,	// channel identifier
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakReadCpuUsageStat_t gpakReadCpuUsage(struct r1t1 *rh,	/* Card containing the DSP */
											   unsigned short int DspId,	// DSP identifier
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakResetCpuUsageStat_t gpakResetCpuUsageStats(struct r1t1 *rh,	/* Card containing the DSP */
													  unsigned short int DspId	// DSP identifier
	);
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakReadFramingStatsStatus_t gpakReadFramingStats(struct r1t1 *rh,	/* Card containing the DSP */
														 unsigned short int DspId,	// DSP identifier
 ...
 *  Status  code indicating success or a specific error.
 */
extern gpakResetFramingStatsStatus_t gpakResetFramingStats(struct r1t1 *rh,	/* Card containing the DSP */
														   unsigned short int DspId	// DSP identifier
	);
...
extern gpakReadDSPMemoryStat_t gpakReadDSPMemoryMap(struct r1t1 *rh,	// Card containing the DSP
													unsigned short int DspId,	// Dsp Identifier
