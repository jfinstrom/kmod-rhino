...
extern void r1t1_card_wait_hpi(struct r1t1 *rh, __u8 flags);

extern void r1t1_card_dsp_set(struct r1t1 *rh, __u32 dsp_address, __u16 dsp_data);

extern __u16 r1t1_card_dsp_get(struct r1t1 *rh, __u32 dsp_address);

extern void r1t1_card_hpic_set(struct r1t1 *rh, __u16 hpic_data);
 ...
 *
 */
extern void gpakReadDspMemory(struct r1t1 *rh,	/* Card containing the DSP */
 ...
 *
 */
extern void gpakWriteDspMemory(struct r1t1 *rh,	/* Card containing the DSP */
							   unsigned short int DspId,	/* DSP Identifier (0 to MAX_DSP_CORES-1) */
							   DSP_ADDRESS DspAddress,	/* DSP's memory address of first word */
 ...
 *
 */
extern void gpakLockAccess(struct r1t1 *rh,	/* Card containing the DSP */
						   unsigned short int DspId	/* DSP Identifier (0 to MAX_DSP_CORES-1) */
	);
 ...
 *
 */
extern void gpakUnlockAccess(struct r1t1 *rh,	/* Card containing the DSP */
							 unsigned short int DspId	/* DSP Identifier (0 to MAX_DSP_CORES-1) */
	);
 ...
 *
 */
extern int gpakReadFile_5510(struct r1t1 *rh,	/* Card containing the DSP */
